...
**Date**: 2026-08-12
**Status**: Draft
**Tipo**: NUOVA spec (il dominio non esiste in `openspec/specs/`, non è stato introdotto da alcun
change precedente, e `sito/` **non esiste** nel repository al momento della change)
...
Vale qui il principio che il design ([design.md](../../design.md)) enuncia una volta per tutte:
...
[`consumo-api-pubblica`](../consumo-api-pubblica/spec.md)); i due temi, i font e gli asset di marca
(spec [`temi-e-identita`](../temi-e-identita/spec.md)); il markup delle immagini (spec
[`immagini-vetrina`](../immagini-vetrina/spec.md)).
