...
**Change**: vetrina-sito-astro
**Date**: 2026-08-12
**Status**: Draft
**Tipo**: NUOVA spec — è il **lato consumatore** del contratto definito dalla spec
[`api-pubblica`](../../../vetrina-api-pubblica/specs/api-pubblica/spec.md) del change precedente,
non ancora archiviata. Quella spec descrive **cosa il backend espone**; questa descrive **come il
sito lo legge**, e in particolare il confine che il DTO ha documentato un change prima che il
consumatore esistesse.
...
`Retry-After`, `Cache-Control` — che sta nella spec [`sito-pubblico`](../sito-pubblico/spec.md); il
markup delle immagini, che sta nella spec [`immagini-vetrina`](../immagini-vetrina/spec.md).
