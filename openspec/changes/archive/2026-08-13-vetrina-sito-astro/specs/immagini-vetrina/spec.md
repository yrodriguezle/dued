...
**Date**: 2026-08-12
**Status**: Draft
**Tipo**: NUOVA spec — è il **lato markup** del DTO dell'immagine definito dalla spec
...
della pipeline di varianti introdotta dalla spec `media-assets`.
...
[`consumo-api-pubblica`](../consumo-api-pubblica/spec.md); l'SVG del logo, che non è una risorsa
remota e sta nella spec [`temi-e-identita`](../temi-e-identita/spec.md).
