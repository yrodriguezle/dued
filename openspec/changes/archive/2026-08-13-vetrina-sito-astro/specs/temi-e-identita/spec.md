...
**Date**: 2026-08-12
**Status**: Draft
**Tipo**: NUOVA spec (nessun dominio di design system esiste in `openspec/specs/`; gli asset di
marca esistono in `docs/brand/` e questa spec è il **primo consumatore** del sottoinsieme che il
loro README destina al sito)
...
[`immagini-vetrina`](../immagini-vetrina/spec.md)); i due prefissi (spec
[`consumo-api-pubblica`](../consumo-api-pubblica/spec.md)); il comportamento HTTP delle pagine
(spec [`sito-pubblico`](../sito-pubblico/spec.md)).
