...
futuri MUST leggere quel campo invece di riderivare la regola ciascuno per conto proprio:
è la definizione su cui l'API pubblica della Fase 2 filtrerà, non `VisibileSulSito` da sola.
