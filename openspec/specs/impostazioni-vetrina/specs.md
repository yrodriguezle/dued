...
|--------|---------------|-----------|
| vetrina-api-pubblica | 2026-08-13 | Spec iniziale del dominio: singleton imposto dal database, migrazione additiva e isolata, nessuna duplicazione degli orari, scrittura ad assegnazione totale, lettura riservata agli amministratori, pagina e voce di menu nella sezione Sito |
