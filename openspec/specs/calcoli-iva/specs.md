...
> Nota sullo schema GraphQL: nessuna modifica. I campi esposti (`importoIva`,
> `imponibile`, `totaleConIva`, `totaleVendite`) restano invariati; è cambiato solo il
> punto in cui i valori vengono calcolati (consolidamento).
>
