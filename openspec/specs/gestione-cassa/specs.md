...
## 10. Requirements: Spese su Registro Giornaliero (spese-su-registro-giornaliero)

Il registro giornaliero ospita **tutte** le spese secondo l'asse contabile
**TRACCIATO / NON-TRACCIATO**:
...
> Il requirement "Formula ContanteAtteso corretta" (sez. 7) resta **invariato**.
