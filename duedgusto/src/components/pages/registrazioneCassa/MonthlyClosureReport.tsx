...
const MonthlyClosureReport: React.FC<MonthlyClosureReportProps> = ({ closure }) => {
    ...
    const handlePrint = () => {
        ...
        const monthName = dayjs().month(closure.mese - 1).format('MMMM').toUpperCase();
        ...
        printWindow.document.write(`
            ...
            <body>
                ...
                <table>
                    ...
                    <tbody>
                        ${closure.registriInclusi.map(ri => `
                            <tr>
                ...
                ${closure.pagamentiInclusi.length > 0 ? `
                    ...
                    <table>
                        ...
                        <tbody>
                            ${closure.pagamentiInclusi.map(p => `
                                <tr>
