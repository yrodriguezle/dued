...
namespace duedgusto.Migrations
{
    ...
    [Migration("20260903084254_PaginaPiattoDellaSettimana")]
    partial class PaginaPiattoDellaSettimana
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("duedgusto.Models.ImpostazioniVetrina", b =>
                {
                    ...
                    b.Property<int?>("ImmagineEroePiattoId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PiattoGiorno")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(2);

                    b.Property<string>("PiattoTesto")
                        .HasColumnType("text");

                    b.Property<string>("PiattoTitolo")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
                    ...
                    b.HasIndex("ImmagineEroePiattoId");
                    ...
                    b.ToTable("ImpostazioniVetrina", null, t =>
                        {
                            t.HasCheckConstraint("CK_ImpostazioniVetrina_PiattoGiorno", "`PiattoGiorno` BETWEEN 0 AND 6");
            ...
            modelBuilder.Entity("duedgusto.Models.ImpostazioniVetrina", b =>
                {
                    ...
                    b.HasOne("duedgusto.Models.MediaAsset", "ImmagineEroePiatto")
                        .WithMany()
                        .HasForeignKey("ImmagineEroePiattoId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ImmagineEroePiatto");
